...
int main()
{
    ...
    //Tutaj znajdują się za równo kolejka monotoniczna na maks i min które szukają na
    //danym przedziale największej różnicy między dwoma elementami mniejszej niż "n"
