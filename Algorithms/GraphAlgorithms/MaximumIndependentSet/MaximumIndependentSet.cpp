...
int main()
{
    ...
    //Znalezienie takiego zbioru nalezy do problemow np zupelnych dlatego tez zlozonosc jest wykladnicza
    //Jednak dzieki podzialowi grafu na punkty o stopniach {0/1},{2},{3...} mozemy to policzyc w zlozonosci 1,38^n
